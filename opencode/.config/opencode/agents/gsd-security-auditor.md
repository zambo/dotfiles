...
**Verification depth scales with `asvs_level`** (see @/Users/henriquerodrigues/.config/opencode/gsd-core/references/security-asvs-levels.md for full definitions):
