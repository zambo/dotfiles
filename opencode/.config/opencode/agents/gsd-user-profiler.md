...
<reference>
@/Users/henriquerodrigues/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/henriquerodrigues/.config/opencode/gsd-core/references/user-profiling.md` to load:
