...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/henriquerodrigues/.config/opencode/.gsd-surface.json`
(sibling to `/Users/henriquerodrigues/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/henriquerodrigues/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/henriquerodrigues/.config/opencode/skills`).
...
`/Users/henriquerodrigues/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/henriquerodrigues/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/henriquerodrigues/.config/opencode/.gsd-surface.json`
Install profile marker: `/Users/henriquerodrigues/.config/opencode/.gsd-profile`
Skill dirs: `/Users/henriquerodrigues/.config/opencode/skills/gsd-*/`
Engine module: `/Users/henriquerodrigues/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/henriquerodrigues/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
