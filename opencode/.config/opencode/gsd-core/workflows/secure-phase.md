...
```
Agent(
  prompt="Read /Users/henriquerodrigues/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/henriquerodrigues/.config/opencode/gsd-core/templates/SECURITY.md`
