...
INSTALL_JS_GLOBAL="/Users/henriquerodrigues/.config/opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/henriquerodrigues/.config/opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
